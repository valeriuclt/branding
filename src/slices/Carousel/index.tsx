...
import FloatingCan from "@/components/FloatingCane";
...
const FLAVORS: {
  ...
  { flavor: "blackCherry", color: "#1e3a8a", name: "Concentrate on results" },
  { flavor: "grape", color: "#572981", name: "Pulp fiction with a twist" },
  {
    flavor: "lemonLime",
    color: "#164405",
    name: "Concentrate on success strategies",
  },
  {
    flavor: "strawberryLemonade",
    color: "#690B3D",
    name: "Premium brand expertise, fresh profit",
  },
  {
    flavor: "watermelon",
    color: "#4B7002",
    name: "Organic authenticity, pure insight",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-[auto,auto,auto] items-center">
        ...
        />
        {/* Can */}
        <View className="aspect-square h-[80vmin] min-h-40">
          <Center position={[0, 0, 1.8]}>
            <FloatingCan
              ref={sodaCanRef}
              floatIntensity={0.3}
              rotationIntensity={1}
