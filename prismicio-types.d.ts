...
/**
 * Default variation for BigTexts Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type BigTextsSliceDefault = prismic.SharedSliceVariation<
  "default",
  Record<string, never>,
  never
>;
...
/**
 * Slice variation for *BigTexts*
 */
type BigTextsSliceVariation = BigTextsSliceDefault;

/**
 * BigTexts Shared Slice
 *
 * - **API ID**: `big_texts`
 * - **Description**: BigTexts
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type BigTextsSlice = prismic.SharedSlice<
  "big_texts",
  BigTextsSliceVariation
>;
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Cans field in *Hero → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.cans
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  cans: prismic.ImageField<never>;
